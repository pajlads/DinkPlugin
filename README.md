...
Examples of the additional metadata can be found [here](https://github.com/Felanbird/DinkPlugin/blob/chore/move-nerd-data-out-of-base-readme/docs/json-examples.md).
