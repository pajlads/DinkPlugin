...
public enum AchievementDiary {
    ...
    MORYTANIA_EASY(Varbits.DIARY_MORYTANIA_EASY, 7, "Lumbridge & Draynor", Difficulty.EASY),
    MORYTANIA_MEDIUM(Varbits.DIARY_MORYTANIA_MEDIUM, 7, "Lumbridge & Draynor", Difficulty.MEDIUM),
    MORYTANIA_HARD(Varbits.DIARY_MORYTANIA_HARD, 7, "Lumbridge & Draynor", Difficulty.HARD),
    MORYTANIA_ELITE(Varbits.DIARY_MORYTANIA_ELITE, 7, "Lumbridge & Draynor", Difficulty.ELITE),
